...
//Modern javascript kütüphaneleri olmadan önceki metodlar
...
for (let i = 0; i < array.length; i++){
    ...
    li.innerText = `isim: ${element.name} Yas : ${element.age}`;
...
const renderUsers = (users = []) => {
  ...
  <tr>
  <th scope="col">Id</th>
    <th scope="col" id="sırala">Sıra No</th>
  ...
  //sıralama
 // document.querySelector("#sırala").addEventListener("click", () => {
  //})
